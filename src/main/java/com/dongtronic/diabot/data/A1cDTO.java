...
public class A1cDTO {
   ...
   */
  public A1cDTO(@NotNull double original, @NotNull double conversion, @NotNull GlucoseUnit inputUnit) {
   ...
   */
  public A1cDTO(@NotNull double original, @NotNull double mmolConversion, @NotNull double mgdlConversion) {
    setOriginal(original);
